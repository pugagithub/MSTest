				...
				if (PriceComparisonWorker.previousRecordSet.get(symbol) != null) {
					if (PriceComparisonWorker.previousRecordSet.get(symbol) != price) {
						...
						System.out.println("Value not correct for :" + symbol + "---> " + "Price in Banking Data"
								+ PriceComparisonWorker.previousRecordSet + "---> Price in 3rd Party --->" + price);
						// TODO
						// What happens if data in Banking is more than Third
						// Party

						

						// TODO
						PricePublishMonitor.alertService.alert("Value not correct for :" + symbol + "---> "
								+ "Price in Banking Data" + PriceComparisonWorker.previousRecordSet
					...
					PricePublishMonitor.alertService
							.alert("This Symbol hasnot been changed in last 30 seconds but wrongly sent to clients");
				}
